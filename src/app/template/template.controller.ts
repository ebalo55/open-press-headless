...
export class TemplateController {
	...
	get onBeforeCreation() {
		...
		return this._events.get(TEMPLATE_CONTROLLER_EVENTS.creation_before).asEvent();
	}
	...
	get onAfterCreation() {
		/* istanbul ignore next */
		return this._events.get(TEMPLATE_CONTROLLER_EVENTS.creation_after).asEvent();
	}
	...
	get onBeforeUpdate() {
		/* istanbul ignore next */
		return this._events.get(TEMPLATE_CONTROLLER_EVENTS.update_before).asEvent();
	}
	...
	get onAfterUpdate() {
		/* istanbul ignore next */
		return this._events.get(TEMPLATE_CONTROLLER_EVENTS.update_after).asEvent();
	}
	...
	get onBeforeDelete() {
		/* istanbul ignore next */
		return this._events.get(TEMPLATE_CONTROLLER_EVENTS.delete_before).asEvent();
	}
	...
	get onAfterDelete() {
		/* istanbul ignore next */
		return this._events.get(TEMPLATE_CONTROLLER_EVENTS.delete_after).asEvent();
	}
	...
	get onBeforeList() {
		/* istanbul ignore next */
		return this._events.get(TEMPLATE_CONTROLLER_EVENTS.list_before).asEvent();
	}
	...
	get onAfterList() {
		/* istanbul ignore next */
		return this._events.get(TEMPLATE_CONTROLLER_EVENTS.list_after).asEvent();
	}
	...
	get onBeforeGet() {
		/* istanbul ignore next */
		return this._events.get(TEMPLATE_CONTROLLER_EVENTS.get_before).asEvent();
	}
	...
	get onAfterGet() {
		/* istanbul ignore next */
		return this._events.get(TEMPLATE_CONTROLLER_EVENTS.get_after).asEvent();
	}
	...
	async create(@Body() template: CreateTemplateDTO) {
		...
		this._events.get(TEMPLATE_CONTROLLER_EVENTS.creation_before).dispatch(this, { template });
	...
	async update(@Param("id") template_id: string, @Body() template: UpdateTemplateDTO) {
		...
		this._events.get(TEMPLATE_CONTROLLER_EVENTS.update_before).dispatch(this, {
			template_id,
			template,
		});
		...
		this._events.get(TEMPLATE_CONTROLLER_EVENTS.update_after).dispatch(this, { document });
	...
	async delete(@Param("id") template_id: string) {
		...
		this._events.get(TEMPLATE_CONTROLLER_EVENTS.delete_before).dispatch(this, { template_id });

		const document = await this._template_service.delete(template_id);

		this._events.get(TEMPLATE_CONTROLLER_EVENTS.delete_after).dispatch(this, { document });
	...
	async get(@Param("id") template_id: string) {
		...
		this._events.get(TEMPLATE_CONTROLLER_EVENTS.get_before).dispatch(this, { template_id });
